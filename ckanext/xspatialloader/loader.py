...
# coding=utf-8
'''
based on spatial ingestor for data.gov.au by <greg.vonnessi@linkdigital.com.au>
'''
...
def do_ingesting(dataset_id, force, ext_logger=None):
    tempdir = None
    if ext_logger:
        logger = ext_logger
    try:
